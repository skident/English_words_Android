...
public class ShowPatternActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_concrete_pattern);
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        {
            case R.id.nav_words:
                intent = new Intent(ShowPatternActivity.this, WordsActivity.class);
                break;
            case R.id.nav_irregular_verb:
                intent = new Intent(ShowPatternActivity.this, IrregularVerbsActivity.class);
                break;
            case R.id.nav_add_words:
                 intent = new Intent(ShowPatternActivity.this, SelectSectionActivity.class);
                break;
